...
//                Cart.sum=0.00;
    ...
    public void getTotal(){
        ...
        badge.setBackgroundColor(ContextCompat.getColor(context,R.color.some_color1));
...
//            Cart.itemcounter.setText("0");
            ...
            if(CartPageFragment.sum >= CartPageFragment.deliveryprice){
                ...
                CartPageFragment.tv_ship_price.setText(String.valueOf(CartPageFragment.delivery_ch));
